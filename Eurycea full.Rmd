---
title: " An Exploration of GBIF data of the Salamader Genus Eurycea"
author: "BradMcFall"
...
######### loop to read in --- GBIF species data and write to directory

#------------------------------Sets and Creates a directory to store files
setwd("C:/Users/Brad McFall/Documents/R/Distributions")
dir.create("GbifEurycea2")

#------------------------------Creates list to read in and sets each name as unique
 
Eurycea_name_list<-c("Eurycea lucifuga","Eurycea longicauda", "Eurycea tynerensis", "Eurycea multiplicata","Eurycea spelaea", "Eurycea bislineata", "Eurycea guttolineata", "Eurycea cirrigera", "Eurycea quadridigitata", "Eurycea wilderae", "Eurycea neotenes","Eurycea chamberlaini", "Eurycea aquatica","Eurycea junaluska","Eurycea chisholmensis","Eurycea latitans", "Eurycea nana","Eurycea naufragia", " Eurycea pterophila", "Eurycea rathbuni", "Eurycea robusta", "Eurycea sosorum","Eurycea subfluvicola", "Eurycea tonkawae", "Eurycea tridentifera", "Eurycea troglodytes", "Eurycea wallacei", "Eurycea waterlooensis","Eurycea tynerensis")


sp_name<-unique(Eurycea_name_list)

#------------------------------loop----- reads in GBIF data for names in a list (only loops over list2)
for(sp_name in Eurycea_name_list){

   name<-occ_search(scientificName = sp_name, limit=400) #calls rgbif occ_serach
   df<-as_tibble(name$data)
   write_csv(df, paste("GbifEurycea2/",sp_name, sep=""))
...
Eurycea_names<- unique(Eurycea_name_list)
for (Eurycea_names in Eurycea_name_list) {
  Eurycea_df[[Eurycea_names]]<-read_csv(paste(path,"GbifEurycea/",Eurycea_names, sep=""))
}
#map(list, read_csv
